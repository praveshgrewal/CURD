...
<body style="background-color: #FFF">
  ...
  <a href="#" class="btn btn-warning pull-right"><span class="glyphicon glyphicon-print"></span> Print PDF</a>
  <hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="1.png" width="300px" height="80px" alt=""></center>
...
<input type="text" class="form-control" name="staff_id" maxlength="5" placeholder="Enter 5-digit Staff Id">
</div>
			 -->
